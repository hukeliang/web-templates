...
@SuppressWarnings({"SpringJavaAutowiredMembersInspection", "UnusedReturnValue", "WeakerAccess"})
public class RedisUtils {
     ...
     * @param value 值
     */
    public static boolean lLeftSet(String key, Object value) {
        try {
     ...
     * @param time  时间(秒)
     */
    public static boolean lLeftSet(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().leftPush(key, value);
            if (time > 0)
                expire(key, time);
